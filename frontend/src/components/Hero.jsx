...
const Hero = () => {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      link.href = '/Greeshmanth_Reddy_Bommireddy_Resume.pdf'
      link.download = 'Greeshmanth_Reddy_Bommireddy_Resume.pdf'
          ...
          <div className="flex-1 max-w-5xl space-y-6 sm:space-y-8 animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 w-full">
              <div className="flex items-center gap-4 sm:gap-6">
                <div className="w-14 h-14 sm:w-16 sm:h-16 md:w-18 md:h-18 lg:w-20 lg:h-20 rounded-full overflow-hidden shadow-lg flex-shrink-0">
                  <img
                    src="https://res.cloudinary.com/diwy2asxu/image/upload/v1711707249/11111111_kenzge.jpg"
                    alt="Greeshmanth Reddy"
                ...
                <div className="flex items-center gap-2 text-medium-gray">
                  ...
                  <span className="text-sm font-medium whitespace-nowrap">Ongole, Andhra Pradesh, India</span>
                </div>
              </div>
            </div>
            ...
            <div className="w-full space-y-4 sm:space-y-6">
              ...
              <div className="w-full max-w-2xl lg:max-w-3xl">
                <p className="text-sm sm:text-base md:text-lg lg:text-xl text-medium-gray leading-relaxed">
                 I’m Greeshmanth Reddy Bommireddy, a Full Stack Developer who builds scalable, intelligent, and user-focused web applications. I work with modern technologies like React, Node.js, PostgreSQL, and Python, and enhance applications with AI-powered features using LangChain and modern AI APIs. I enjoy turning real-world problems into clean, efficient, and impactful digital solutions
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 w-full animate-fade-in-up" style={{animationDelay: '0.3s'}}>
              ...
              <div className="flex items-center gap-3 sm:gap-4">
                <a 
                  href="https://www.linkedin.com/in/greeshmanthbommireddy/" 
                ...
                <a 
                  href="https://github.com/GreeshmanthBommireddy" 
                  className="w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 bg-charcoal text-white rounded-full flex items-center justify-center smooth-transition hover:-translate-y-2 hover:shadow-lg flex-shrink-0"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a 
                  href="https://www.instagram.com/_greeshuuuh__/" 
                  className="w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 bg-charcoal text-white rounded-full flex items-center justify-center smooth-transition hover:-translate-y-2 hover:shadow-lg flex-shrink-0"
                  target="_blank"
                  rel="noopener noreferrer"
