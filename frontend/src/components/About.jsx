          ...
          <div className="animate-fade-in-up">
            ...
            <div className="space-y-6 text-medium-gray leading-relaxed">
              <p className="text-base lg:text-lg">
               I’m Greeshmanth Reddy Bommireddy, a Full Stack Developer with a strong interest in building scalable web applications and AI-powered tools. I have hands-on experience developing end-to-end solutions using React, Node.js, Python, FastAPI, and Django REST Framework, along with modern AI technologies like LangChain and FAISS.
              </p>
              <p className="text-base lg:text-lg">
              Through real-world projects such as an AI Research Assistant and an AI-powered Resume Analyzer, I’ve worked on integrating intelligent features into applications while ensuring clean architecture, efficient APIs, and reliable database design. I enjoy solving practical problems, learning new technologies, and continuously improving the performance and usability of the products I build.
              </p>
              <p className="text-base lg:text-lg">
                I’m passionate about turning ideas into impactful digital solutions and contributing meaningfully to innovative software teams.
              </p>
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="relative pl-6">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-medium-gray font-medium mb-1">Industry Ready Certification in Full Stack Development</p>
                        <span className="text-xs text-medium-gray italic">2022 - Present</span>
                      </div>
                    </div>
                    ...
                    <div className="relative pl-6">
                      ...
                      <div>
                        <h4 className="font-semibold text-charcoal text-base mb-1">Kallam Haranadhareddy Institute of Technology, Guntur</h4>
                    ...
                    <div className="relative pl-6">
                      ...
                      <div>
                        <h4 className="font-semibold text-charcoal text-base mb-1">Sri Nagabhairava Junior College, Ongole</h4>
