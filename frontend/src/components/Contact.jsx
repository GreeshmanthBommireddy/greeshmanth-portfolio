  ...
  const contactInfo = [
    {
      ...
      title: 'WhatsApp',
      value: '+91 8639791231',
      link: 'https://wa.me/918639791231'
    },
    {
      icon: <FaEnvelope size={16} className="lg:hidden" />,
      iconLg: <FaEnvelope size={20} className="hidden lg:block" />,
      title: 'Email',
      value: 'greeshmanthbommireddy@gmail.com',
      link: 'mailto:greeshmanthbommireddy@gmail.com'
    },
    {
    ...
    },
    {
      ...
      title: 'LinkedIn',
      value: 'greeshmanthbommireddy',
      link: 'https://www.linkedin.com/in/greeshmanthbommireddy/'
    }
  ]
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-6 text-center">
                  <div className="mb-6 text-center">
                    <p className="text-sm text-medium-gray">
                      <FaWhatsapp className="text-green-600 text-lg inline mr-1" /> Your message will be sent directly to Greeshmanth's WhatsApp with instant notification
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <span className="block md:hidden">
                    {loading ? 'Sending...' : 'Send to Greeshmanth'}
                  </span>
                  <span className="hidden md:block">
                    {loading ? 'Sending Direct Message...' : 'Send Direct Message to Greeshmanth'}
                  </span>
